...
'use client'; // This page needs client-side interactivity for image gallery, color/size selection
...
interface ProductDetailPageProps {
  ...
  // When this is a Client Component, we use `useParams()`.
  // However, the initial fetch can still be done in a wrapper Server Component if desired.
  // For simplicity and direct control, we'll fetch client-side here.
}
          ...
          <div className="flex flex-wrap gap-3">
            {product.colors.map(color => (
              <button
                ...
                style={{ backgroundColor: color.toLowerCase() }} // Use actual color for background
