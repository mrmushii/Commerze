...
export default async function AdminDashboardPage() {
  ...
  try {
    ...
    const formattedSalesData = salesData.map(data => ({
      ...
      sales: parseFloat(data.totalSales.toFixed(2)),
      orders: data.count,
    }));
          ...
          <ul className="flex justify-center space-x-6 text-blue-600">
            ...
            <li>
              <Link href="/admin/orders" className="flex flex-col items-center hover:text-blue-800 transition-colors">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.769.742 1.769H19a2 2 0 002-2v-3a2 2 0 00-2-2H8.286c-.967 0-1.749-.117-2.286.333V6.75M9 16.5V18a2 2 0 002 2h4a2 2 0 002-2v-1.5M10 21h4"></path></svg>
