...
const Navbar = () => {
  ...
  return (
    <nav className="relative w-full bg-white border-b border-gray-200 py-4 px-6 md:px-10 shadow-sm z-50"> {/* Base nav styling */}
      <div className="container mx-auto flex items-center justify-between gap-4">
        ...
        <ul className="hidden md:flex items-center space-x-6 flex-shrink-0 ml-8"> {/* Hide on small, show on md+ */}
          <NavMenuLink href="/products" label="Shop" hasDropdown />
          <NavMenuLink href="/products?type=On Sale" label="On Sale" />
          <NavMenuLink href="/products?type=New Arrivals" label="New Arrivals" />
          <NavMenuLink href="/products?type=Brands" label="Brands" /> {/* Placeholder for brands */}
        </ul>
